...
def plot_tsne(embeddings, labels, save_name="tsne_plot.png", perplexity=30,title="None"):
    ...
    label_names = ['angry', 'excited', 'frustrated', 'happy', 'neutral', 'sad']
...
def run_all_tsne(target_files, output_dir):
    ...
    for name, pt_path in target_files.items():
        save_path = os.path.join(output_dir, f"IEMOCAP_{name}_tsne.png")
...
if __name__ == "__main__":
    pt_files = {
        "text": "./IEMOCAP/figures/embedding/pt/text_embedding.pt",
        "audio": "./IEMOCAP/figures/embedding/pt/audio_embedding.pt",
        "visual": "./IEMOCAP/figures/embedding/pt/visual_embedding.pt",
        "fusion": "./IEMOCAP/figures/embedding/pt/fusion_embedding.pt",
    }

    output_dir = "./IEMOCAP/figures/embedding/tsne/"
